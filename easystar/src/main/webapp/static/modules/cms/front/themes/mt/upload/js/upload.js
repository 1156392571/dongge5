...
//    $(function() {
    ...
    this.initWebUploader = function(webUploaderId, filePickerId, fileAddId, uploadUrl,ImageClass) {	
    	
        var $wrap = $(webUploaderId),
        
            // 图片容器
            $queue = $( '<ul id="filelist" class="filelist"></ul>' ).appendTo( $wrap.find( '.queueList' ) ),
...
//                ImageClass: "project"
            ...
            // 文件接收服务端,写你要执行的方法就行
//            server: ctx + '/upload?method=upload',
            server: uploadUrl,
        ...
        function addFile( file ) {
            var $li = $( '<li id="' + file.id + '"><div class="item">' +
                ...
                $btns = $('<div class="file-panel">' +
                    '<span class="cancel">删除</span>' + '</div>').appendTo( $li.find('.item') ),
...
//                        createQrcode();
        ...
        uploader.on('uploadSuccess',function(file,response){
        	...
        	//设置上传图片地址
//        	document.getElementById("shareUrl").value = realurl;
//        	document.getElementById("stTeampic").value = realurl;
//        	document.getElementById("yushow").src = ctxw + realurl;
//        	alert(imgurl);
//        	alert(ImageClass);
//        	setState( 'pedding' );
//        	uploader.removeFile(file);
