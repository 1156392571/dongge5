...
<body>
	<div class="page-container" style="margin-top: 20px;">
		...
		<form:form id="inputForm" modelAttribute="tUser" action="${ctx}/saveRegister" method="post" class="form-horizontal">
			...
			<form:input path="tName" htmlEscape="false" class="scSex" maxlength="255" placeholder="真实姓名"/>
			<form:input path="tPhone" htmlEscape="false" class="scPhone" maxlength="255" placeholder="手机号(必填)"/>
			<form:input path="tEmail" htmlEscape="false" class="scEmail" maxlength="255" placeholder="电子邮箱"/>
			<form:input path="qq" htmlEscape="false" class="scQq" maxlength="255" placeholder="QQ"/>
			<form:input path="wx" htmlEscape="false" class="scWx" maxlength="255" placeholder="微信"/>
			<form:input path="tCompany" htmlEscape="false" class="scWx" maxlength="255" placeholder="公司名称"/>
			<form:input path="tCompanyurl" htmlEscape="false" class="scWx" maxlength="255" placeholder="公司网址"/>
